...
*/
    ...
    //Display account details and statistics
    ...
    public function actionUpload()
    {
        ...
        if (Yii::$app->request->isPost) {
            ...
            if ($model->file && $model->validate()) {                
                $model->file->saveAs('uploads/' . $model->file->baseName .'-'.Yii::$app->formatter->asTimestamp(date(date('Y-m-d H:i:s'))). '.' . $model->file->extension);
            }
        }
